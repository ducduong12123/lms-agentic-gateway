...
from lms_copilot.copilot import course_import, proposals, tools
...
class TestCourseImport(CopilotTestCase):
	...
	def _import(self):
		self.as_user(self.instructor)
		with patch("lms_copilot.copilot.gateway.enqueue_course_import", return_value=True) as enqueue:
