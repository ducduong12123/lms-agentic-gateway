...
from lms_copilot.copilot.read_tools import rubric_for_assignment, serialise_rubric, serialise_tests
...
def submit_project(assignment, repo_url, lesson=None):
	...
	from lms_copilot.copilot.gateway import enqueue_review
